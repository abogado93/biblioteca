...
class PasswordUtil
{
    ...
    /**
     * @param $passwordSent
     * @param Password $passwordHashed
     * @return bool
     */
    public static function validatePassword($passwordSent, Password $passwordHashed) {
        $pbkdf2 = base64_decode($passwordHashed->getHash());
