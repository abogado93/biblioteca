...
return array(
    'ActivationToken' => $baseDir . '/application/util/security/password/ActivationToken.php',
    'AjaxResponse' => $baseDir . '/application/model/AjaxResponse.php',
    'Application' => $baseDir . '/application/core/Application.php',
    'Auth' => $baseDir . '/application/controller/auth.php',
    'Cliente' => $baseDir . '/application/model/Cliente.php',
    'ClienteBuilder' => $baseDir . '/application/model/ClienteBuilder.php',
    'ClienteDao' => $baseDir . '/application/model/dao/ClienteDao.php',
    'Clientes' => $baseDir . '/application/controller/clientes.php',
    'Connection' => $baseDir . '/application/database/Connection.php',
    'Controller' => $baseDir . '/application/core/Controller.php',
    'ControllerCustomProperties' => $baseDir . '/application/core/ControllerCustomProperties.php',
    'DetalleFactura' => $baseDir . '/application/model/DetalleFactura.php',
    'DetalleFacturaBuilder' => $baseDir . '/application/model/DetalleFacturaBuilder.php',
    'DetalleFacturaDao' => $baseDir . '/application/model/dao/DetalleFacturaDao.php',
    'ExpiredSessionException' => $baseDir . '/application/core/Session.php',
    'Factura' => $baseDir . '/application/model/Factura.php',
    'FacturaBuilder' => $baseDir . '/application/model/FacturaBuilder.php',
    'FacturaDao' => $baseDir . '/application/model/dao/FacturaDao.php',
    'Facturas' => $baseDir . '/application/controller/facturas.php',
    'FileException' => $baseDir . '/application/exception/FileException.php',
    'Home' => $baseDir . '/application/controller/home.php',
    'IPaginator' => $baseDir . '/application/util/paginator/IPaginator.php',
    'ImageProcessingException' => $baseDir . '/application/exception/ImageProcessingException.php',
    'InvalidActivationTokenException' => $baseDir . '/application/exception/InvalidActivationTokenException.php',
    'Logout' => $baseDir . '/application/controller/logout.php',
    'NotFound' => $baseDir . '/application/controller/not_found.php',
    'NumberInWords' => $baseDir . '/application/util/NumberInWords.php',
    'Owasp' => $baseDir . '/application/util/security/Owasp.php',
    ...
    'Paginator' => $baseDir . '/application/util/paginator/Paginator.php',
    'PaginatorWrapper' => $baseDir . '/application/util/paginator/PaginatorWrapper.php',
    'Password' => $baseDir . '/application/util/security/password/Password.php',
    'PasswordException' => $baseDir . '/application/exception/PasswordException.php',
    'PasswordUtil' => $baseDir . '/application/util/security/password/PasswordUtil.php',
    ...
    'Producto' => $baseDir . '/application/model/Producto.php',
    'ProductoBuilder' => $baseDir . '/application/model/ProductoBuilder.php',
    'ProductoDao' => $baseDir . '/application/model/dao/ProductoDao.php',
    'Productos' => $baseDir . '/application/controller/productos.php',
    'RBAC' => $baseDir . '/application/util/rbac/RBAC.php',
    'RBACDelegate' => $baseDir . '/application/util/rbac/RBACDelegate.php',
    'RBACFailDelegate' => $baseDir . '/application/core/RBACFailDelegate.php',
    'Redirection' => $baseDir . '/application/traits/Redirection.php',
    'RequestStatus' => $baseDir . '/application/model/RequestStatus.php',
    'Roles' => $baseDir . '/application/util/rbac/RBAC.php',
    'RowNotFoundException' => $baseDir . '/application/exception/RowNotFoundException.php',
    ...
    'SessionHandlerException' => $baseDir . '/application/core/Session.php',
    ...
    'Usuario' => $baseDir . '/application/model/Usuario.php',
    'UsuarioBuilder' => $baseDir . '/application/model/UsuarioBuilder.php',
    'UsuarioDao' => $baseDir . '/application/model/dao/UsuarioDao.php',
    'Usuarios' => $baseDir . '/application/controller/usuarios.php',
    'Util' => $baseDir . '/application/util/Util.php',
);
