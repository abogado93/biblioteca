...
class ComposerStaticInit6cd207203729146276c5214914e2f9f8
{
    ...
    public static $classMap = array (
        'ActivationToken' => __DIR__ . '/../..' . '/application/util/security/password/ActivationToken.php',
        'AjaxResponse' => __DIR__ . '/../..' . '/application/model/AjaxResponse.php',
        'Application' => __DIR__ . '/../..' . '/application/core/Application.php',
        'Auth' => __DIR__ . '/../..' . '/application/controller/auth.php',
        'Cliente' => __DIR__ . '/../..' . '/application/model/Cliente.php',
        'ClienteBuilder' => __DIR__ . '/../..' . '/application/model/ClienteBuilder.php',
        'ClienteDao' => __DIR__ . '/../..' . '/application/model/dao/ClienteDao.php',
        'Clientes' => __DIR__ . '/../..' . '/application/controller/clientes.php',
        'Connection' => __DIR__ . '/../..' . '/application/database/Connection.php',
        'Controller' => __DIR__ . '/../..' . '/application/core/Controller.php',
        'ControllerCustomProperties' => __DIR__ . '/../..' . '/application/core/ControllerCustomProperties.php',
        'DetalleFactura' => __DIR__ . '/../..' . '/application/model/DetalleFactura.php',
        'DetalleFacturaBuilder' => __DIR__ . '/../..' . '/application/model/DetalleFacturaBuilder.php',
        'DetalleFacturaDao' => __DIR__ . '/../..' . '/application/model/dao/DetalleFacturaDao.php',
        'ExpiredSessionException' => __DIR__ . '/../..' . '/application/core/Session.php',
        'Factura' => __DIR__ . '/../..' . '/application/model/Factura.php',
        'FacturaBuilder' => __DIR__ . '/../..' . '/application/model/FacturaBuilder.php',
        'FacturaDao' => __DIR__ . '/../..' . '/application/model/dao/FacturaDao.php',
        'Facturas' => __DIR__ . '/../..' . '/application/controller/facturas.php',
        'FileException' => __DIR__ . '/../..' . '/application/exception/FileException.php',
        'Home' => __DIR__ . '/../..' . '/application/controller/home.php',
        'IPaginator' => __DIR__ . '/../..' . '/application/util/paginator/IPaginator.php',
        'ImageProcessingException' => __DIR__ . '/../..' . '/application/exception/ImageProcessingException.php',
        'InvalidActivationTokenException' => __DIR__ . '/../..' . '/application/exception/InvalidActivationTokenException.php',
        'Logout' => __DIR__ . '/../..' . '/application/controller/logout.php',
        'NotFound' => __DIR__ . '/../..' . '/application/controller/not_found.php',
        'NumberInWords' => __DIR__ . '/../..' . '/application/util/NumberInWords.php',
        'Owasp' => __DIR__ . '/../..' . '/application/util/security/Owasp.php',
        ...
        'Paginator' => __DIR__ . '/../..' . '/application/util/paginator/Paginator.php',
        'PaginatorWrapper' => __DIR__ . '/../..' . '/application/util/paginator/PaginatorWrapper.php',
        'Password' => __DIR__ . '/../..' . '/application/util/security/password/Password.php',
        'PasswordException' => __DIR__ . '/../..' . '/application/exception/PasswordException.php',
        'PasswordUtil' => __DIR__ . '/../..' . '/application/util/security/password/PasswordUtil.php',
        ...
        'Producto' => __DIR__ . '/../..' . '/application/model/Producto.php',
        'ProductoBuilder' => __DIR__ . '/../..' . '/application/model/ProductoBuilder.php',
        'ProductoDao' => __DIR__ . '/../..' . '/application/model/dao/ProductoDao.php',
        'Productos' => __DIR__ . '/../..' . '/application/controller/productos.php',
        'RBAC' => __DIR__ . '/../..' . '/application/util/rbac/RBAC.php',
        'RBACDelegate' => __DIR__ . '/../..' . '/application/util/rbac/RBACDelegate.php',
        'RBACFailDelegate' => __DIR__ . '/../..' . '/application/core/RBACFailDelegate.php',
        'Redirection' => __DIR__ . '/../..' . '/application/traits/Redirection.php',
        'RequestStatus' => __DIR__ . '/../..' . '/application/model/RequestStatus.php',
        'Roles' => __DIR__ . '/../..' . '/application/util/rbac/RBAC.php',
        'RowNotFoundException' => __DIR__ . '/../..' . '/application/exception/RowNotFoundException.php',
        ...
        'Session' => __DIR__ . '/../..' . '/application/core/Session.php',
        'SessionHandlerException' => __DIR__ . '/../..' . '/application/core/Session.php',
        ...
        'Usuario' => __DIR__ . '/../..' . '/application/model/Usuario.php',
        'UsuarioBuilder' => __DIR__ . '/../..' . '/application/model/UsuarioBuilder.php',
        'UsuarioDao' => __DIR__ . '/../..' . '/application/model/dao/UsuarioDao.php',
        'Usuarios' => __DIR__ . '/../..' . '/application/controller/usuarios.php',
        'Util' => __DIR__ . '/../..' . '/application/util/Util.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit6cd207203729146276c5214914e2f9f8::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit6cd207203729146276c5214914e2f9f8::$prefixDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInit6cd207203729146276c5214914e2f9f8::$prefixesPsr0;
            $loader->classMap = ComposerStaticInit6cd207203729146276c5214914e2f9f8::$classMap;
