let rules = {
    ...
    required_fields : [
        ...
        },
        {
		  ...
		  {
            id : "dias",
            message : "Debe ingresar los dias de prestamo.",
        },
...
function add() {
    ...
    let data = $("#frm-prestamo").serializeArray();

    $.ajax({
        url: ROOT_FOLDER + "prestamos/add/",
        type: 'POST',
        data : data,
        dataType: "json"
    })
...
function modify() {
    ...
    $.ajax({
        url: ROOT_FOLDER + "prestamos/modify/",
        type: 'POST',
        data: data,
        dataType: "json"
    })
        .done(function(data) {
            ...
            if(data.status === RequestStatus.OK) {
                swal(
                    ...
                    function(isConfirm) {
                        window.location = ROOT_FOLDER + "prestamos/list";
                    }
                );
...
function remove() {
    ...
    $.ajax({
        url: ROOT_FOLDER + "prestamos/remove/",
        type: 'POST',
        data: $("#frm-prestamo").serialize(),
        dataType: "json"
    })
        .done(function(data) {
            console.log("data: " + data);
...
function removePrestamo() {

    swal(
        {
            title: 'Atención!',
            text: 'Estás a punto de eliminar un prestamo. ¿Querés continuar?',
            type: 'warning',
